...
## 2. Test the API on the Real Domain (`bluecore.gbanchs.com`)
...
## 3. Deploy the API on Kubernetes (Minikube)
...
### 3.2. Deploy the Application with Kubernetes Manifests
...
## 4. Local Environment Configuration (`setenvs.sh`)
...
### 4.2. Deploy to Different Environments
...
## 5. Terraform Deployment (for AWS infrastructure)
...
### 5.2. Create the Global Environment
...
### 5.4. Custom Resource Creation Configuration
